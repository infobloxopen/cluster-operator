...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Contexts) DeepCopyInto(out *Contexts) {
	*out = *in
	if in.Context != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Contexts.
func (in *Contexts) DeepCopy() *Contexts {
	if in == nil {
		return nil
	}
	out := new(Contexts)
